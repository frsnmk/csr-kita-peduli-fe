      ...
      {previewImage && (
...

        {
          selectedFile && (<button
            ...
            className={`flex items-center mx-auto space-x-2 text-white font-bold py-3 px-6 rounded-lg shadow-md ${ isSubmitting ? 'bg-green-300 cursor-not-allowed' : 'bg-green-700'} transition duration-300 mt-4`}
          >
          {
            isSubmitting ? (
              <>
