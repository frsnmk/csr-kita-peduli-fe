    ...
    isShowed && (
      <div className="fixed bottom-0 w-full bg-white shadow-lg max-w-[480px] mx-auto left-0 right-0">
        <div className="flex justify-around items-center py-3">
          ...
          >
            <div
              className={clsx("px-4 py-1 rounded-lg", {
                "bg-green-200": pathname === "/",
              })}
            >
              <HomeIcon
          ...
          >
            <div
              className={clsx("px-4 py-1 rounded-lg", {
                "bg-green-200": pathname === "/programs",
              })}
            >
              <LocalOfferIcon
                className={clsx("h-6 w-6", {
                  "text-green-700": pathname === "/programs",
                  "text-gray-700": pathname !== "/programs",
                })}
              />
            </div>
            <span
          ...
          >
            <div
              className={clsx("px-4 py-1 rounded-lg", {
                "bg-green-200": pathname === "/profiles",
              })}
            >
              <AccountCircleIcon
                className={clsx("h-6 w-6", {
                  "text-green-700": pathname === "/profiles",
                  "text-gray-700": pathname !== "/profiles",
                })}
              />
            </div>
            <span
          ...
          {isLoggedIn && (
            ...
            >
              <div
                className={clsx("px-4 py-1 rounded-lg", {
                  "bg-green-200": pathname === "/histories",
                })}
              >
                <RestoreIcon
                  className={clsx("h-6 w-6", {
                    "text-green-700": pathname === "/histories",
                    "text-gray-700": pathname !== "/histories",
                  })}
                />
              </div>
              <span
          ...
          <Link
            href="https://company.kitapeduli.id"
            className="flex flex-col items-center justify-center"
            passHref
          >
