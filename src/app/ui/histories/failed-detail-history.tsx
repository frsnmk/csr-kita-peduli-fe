...
interface FailedDetailHistoryProps {
        ...
        <div className="p-4 relative">
            ...
            <div className="bg-white rounded-lg p-4 space-y-4">
                ...
                <div className="flex justify-between mb-2">
                    ...
                    <span className="text-sm text-orange-600 font-bold">Ditolak</span>
                </div>
                <div className="flex justify-between mb-2">
                    <span className="text-sm text-gray-600">Alasan penolakan</span>
                    <span className="text-sm text-gray-800 font-bold">{data.reason_payment_is_rejected}</span>
                </div>
...
export default FailedDetailHistory;